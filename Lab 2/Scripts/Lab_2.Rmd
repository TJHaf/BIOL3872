...
<<<<<<< HEAD
sample_id <- "42" #numbers in quotations are characters"
...
```{r}
<<<<<<< HEAD
5 > 3         # TRUE (5 is greater than 3) #asking R if 5 is greater than 3, will respond "5"
=======
...
can_fly <- FALSE
<<<<<<< HEAD
is_mammal & can_fly #cannot be a mammal,, and fly, these values were prev assigned 
=======
is_mammal & can_fly
>>>>>>> refs/remotes/origin/main
is_mammal | can_fly
...
# Your code here:
<<<<<<< HEAD
dolphin_scientific_name <- "Delphinidae"
dolphin_average_lifespan_years <- 55
dolphin_is_extant <- TRUE 
class(dolphin_scientific_name)
class(dolphin_average_lifespan_years)
class(dolphin_is_extant)
=======
...
<<<<<<< HEAD
#$ references a column in a dataframe
=======
>>>>>>> refs/remotes/origin/main
...
\<\<\<\<\<\<\< HEAD \## Replacing Missing Values ======= \## Replacing Missing Values \>\>\>\>\>\>\> refs/remotes/origin/main
...
median(na.omit(measurements$length))
